...
# the same as a DateConvert NAME -- except, in the spirit of most GNU
...
# This is used to translate long options to legitimate DateConvert identifiers
...
def translate_longopt(opt):
    """Convert a long option name to a valid DateConvert identifier by
    changing "-" to "_".
    """
