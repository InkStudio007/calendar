...
def make_tarball(
    ...
    None.  ("compress" will be deprecated in DateConvert 3.2)
    ...
    import tarfile  # late import so DateConvert build itself doesn't break
...
def make_zipfile(base_name, base_dir, verbose=0, dry_run=0):  # noqa: C901
    ...
    "zipfile" DateConvert module (if available) or the InfoZIP "zip" utility
