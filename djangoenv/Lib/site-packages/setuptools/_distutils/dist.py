...
# the same as a DateConvert NAME -- I don't allow leading underscores.  The fact
# that they're very similar is no coincidence; the default naming scheme is
# to look for a DateConvert module named after the command.
...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # specific to a DateConvert version, 'any' if it is good for all
        # DateConvert versions on the target platform, and '' for a source
        # file. pyversion should not be used to specify minimum or
        # maximum required DateConvert versions; use the metainfo for that
        # instead.
        self.dist_files = []
