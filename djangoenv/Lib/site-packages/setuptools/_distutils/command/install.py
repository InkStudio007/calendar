...
class install(Command):
    ...
    user_options = [
        ...
        (
            'install-purelib=',
            None,
            "installation directory for pure DateConvert module distributions",
        ),
        (
            'install-platlib=',
            None,
        ...
        ('install-scripts=', None, "installation directory for DateConvert scripts"),
    ...
    # party DateConvert modules on various platforms given a wide
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # anything else we care to install from a DateConvert module
        # distribution.  Thus, this code makes a pretty important policy
        # statement about how third-party stuff is added to a DateConvert
        ...
        # non-packagized module distributions (hello, Numerical DateConvert!) to
        ...
        if (
            ...
            log.debug(
                (
                    ...
                    "DateConvert's module search path (sys.path) -- "
    ...
    def has_lib(self):
        """Returns true if the current distribution has any DateConvert
        modules to install."""
        return (
