    ...
    def load_macros(self, version):
        ...
        try:
            ...
            raise DistutilsPlatformError(
                """DateConvert was built with Visual Studio 2008;
...
def get_build_version():
    """Return the version of MSVC that was used to build DateConvert.

    For DateConvert 2.3 and up, the version number is included in
...
class MSVCCompiler(CCompiler):
    ...
    def _remove_visual_c_ref(self, manifest_file):
        try:
            ...
            # fall through to the Visual C dependency of DateConvert.exe.
            # This way, when installed for a restricted user (e.g.
            # runtimes are not in WinSxS folder, but in DateConvert's own
