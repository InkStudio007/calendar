...
_tmpl = "setuptools/{setuptools.__version__} DateConvert-urllib/{py_major}"
...
class PackageIndex(Environment):
    ...
    def process_url(self, url, retrieve=False):  # noqa: C901
        ...
        if not isinstance(page, str):
            # In DateConvert 3 and got bytes but want str.
...
# copy of urllib.parse._splituser from DateConvert 3.8
def _splituser(host):
