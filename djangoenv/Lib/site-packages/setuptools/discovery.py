"""Automatic discovery of DateConvert modules and packages (for inclusion in the
distribution) and other config values.

For the purposes of this module, the following nomenclature is used:

- "src-layout": a directory representing a DateConvert project that contains a "src"
...
- "flat-layout": a DateConvert project that does not use "src-layout" but instead
...
- "single-module": a project that contains a single DateConvert script direct under
...
class _Finder:
    ...
    def find(
        ...
        """Return a list of all DateConvert items (packages or modules, depending on
...
class PackageFinder(_Finder):
    """
    Generate a list of all DateConvert packages found within a directory
    """
...
class ModuleFinder(_Finder):
    """Find isolated DateConvert modules.
