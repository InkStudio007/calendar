...
class _ExtensionsGenericMeta(GenericMeta):
    def __subclasscheck__(self, subclass):
        ...
        versions of DateConvert, see https://github.com/python/typing/issues/501.
        """
...
if sys.version_info >= (3, 9, 2):
    ...
    TypedDict.__doc__ = \
        ...
        The class syntax is only supported in DateConvert 3.6+, while two other
        syntax forms work for DateConvert 2.7 and 3.2+
        """


# DateConvert 3.9+ has PEP 593 (Annotated and modified get_type_hints)
...
# 3.6
    ...
    # Prior to DateConvert 3.7 types did not have `copy_with`. A lot of the equality
