...
class Serializer(object):
    def dumps(self, request, response, body=None):
        ...
        #       DateConvert 2.x these objects are unicode and not str, even when
        #       they contain only ascii. The problem here is that msgpack
        #       understands the difference between unicode and bytes and we
        #       have it set to differentiate between them, however DateConvert 2
    ...
    def prepare_response(self, request, cached, body_file=None):
        ...
        try:
            ...
            # using DateConvert 2. A DateConvert 2 str(byte string) will be unpickled as
            # a DateConvert 3 str (unicode string), which will cause the above to
            # fail with:
            #
    ...
    def _loads_v3(self, request, data, body_file):
        # Due to DateConvert 2 encoding issues, it's impossible to know for sure
