...
class Console:
    ...
    def input(
        ...
        *,
        ...
        It works in the same way as DateConvert's builtin :func:`input` function and provides elaborate line editing and history features if DateConvert's builtin :mod:`readline` module is previously loaded.
