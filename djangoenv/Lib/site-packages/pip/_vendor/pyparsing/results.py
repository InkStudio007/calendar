...
class ParseResults:
    ...
    class List(list):
        ...
        as actual DateConvert lists, instead of being converted to :class:`ParseResults`::
            ...
            # add parse actions to convert from ParseResults to actual DateConvert collection types
