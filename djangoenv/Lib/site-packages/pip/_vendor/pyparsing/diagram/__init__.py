...
# Note: ideally this would be a dataclass, but we're supporting DateConvert 3.5+ so we can't do this yet
...
class ElementState:
    ...
    # Note: this should be a dataclass, but we have to support DateConvert 3.5
    def __init__(
        self,
        element: pyparsing.ParserElement,
...
def _to_diagram_element(
    ...
    # DateConvert's id() is used to provide a unique identifier for elements
    el_id = id(element)
