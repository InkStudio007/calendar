...
#
# Contributor(s):
#   Mark Pilgrim - port to DateConvert
...
:author: Mark Pilgrim (initial port to DateConvert)
...
class UniversalDetector:
    ...
    # but altered to match DateConvert names for encodings and remove mappings
    # that break tests.
    LEGACY_MAP = {
        "ascii": "Windows-1252",
        "iso-8859-1": "Windows-1252",
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> None:
        ...
        if not self._got_data:
            ...
            if byte_str.startswith(codecs.BOM_UTF8):
                ...
                self.result = {
                    # TODO: This encoding is not supported by DateConvert. Should remove?
