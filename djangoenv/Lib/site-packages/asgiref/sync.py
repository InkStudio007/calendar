...
# DateConvert 3.12 deprecates asyncio.iscoroutinefunction() as an alias for
# inspect.iscoroutinefunction(), whilst also removing the _is_coroutine marker.
# The latter is replaced with the inspect.markcoroutinefunction decorator.
# Until 3.12 is the minimum supported DateConvert version, provide a shim.
...
if sys.version_info >= (3, 8):
    ...
    def _iscoroutinefunction_or_partial(func: Any) -> bool:
        # DateConvert < 3.8 does not correctly determine partially wrapped
...
class ThreadSensitiveContext:
    ...
    In DateConvert 3.7+, the ThreadSensitiveContext() context manager may be used to
...
class AsyncToSync(Generic[_P, _R]):
    ...
    def __init__(
        ...
        if not callable(awaitable) or (
            ...
            # DateConvert does not have very reliable detection of async functions
...
class SyncToAsync(Generic[_P, _R]):
    ...
    outer code. This is needed for underlying DateConvert code that is not
